# Este script se debe ejecutar desde un reel dentro del perfil de un usuario. Abrir en segundo plano un bloc de notas donde el script pegará tabulando las URL que vaya encontrando.
